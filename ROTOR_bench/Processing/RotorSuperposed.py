...
class RotorSuperposedTab(QWidget):
    ...
    __slots__ = ('main', 'XYZ', 
                 ...
                 'ROTOR_L_group_box', 'ROTOR_L_checkBtn', 'ROTOR_L_sel_Zpos', 'ROTOR_L_sel_angle',
    ...
    def __init__(self, main_window):
        ...
        btn = QPushButton('Plot Superposed Fields')
    ...
    def set_XYZ(self, state, lab):
        ...
        if self.main.curr_plt_info_B_L_S['func']: self.main.curr_plt_info_B_L_S['func']()
    ...
    def set_B_L_S(self, state, label):
        ...
        if label == 'B':
            ...
            self.ROTOR_B_Zpos_combo.setEnabled(self.ROTOR_B_sel==1)
        elif label == 'L':
    ...
    def save_current_plot(self):
        ...
        if self.main.ROTOR_L_txt_file is not None:
            file_name += f'{self.main.ROTOR_L_txt_file.name}@Zpos-{Zpos_L}mm_shift-{shift}__'
