...
def plot_ROTOR(fille_path, xyz=(1,1,1), show=True):
    ...
    # plot the data
    plot_magField_at_positions(A, magnField, list_pos, fille_path, figsize=(10,8), mode=mode, show=show, xyz=xyz)
...
if __name__ == "__main__":
    ...
    if not list_file:
        ...
        while True:
            ...
            plot_ROTOR(file_path, xyz=Txyz)
            
    else:
        for f in list_file:
            f_path = os.path.join(data_dir, f)
            plot_ROTOR(f_path, xyz=Txyz, show=False)
