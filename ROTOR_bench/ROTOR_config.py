...
class Param(Enum):
    ...
    SENSOR_Oe_mT      = 1.e-2  # multiplicative coeff to convert sensor Oe unit to milli-Tesla [mT]
...
class Zaxis(Enum):
    ...
    Zref_velocity       = 2     # the velocity [mm/s] for reaching the limit switch sensor
